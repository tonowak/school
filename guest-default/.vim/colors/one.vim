...
if has('gui_running') || has('termguicolors') || &t_Co == 88 || &t_Co == 256
  ...
  call <sid>X('Search',       s:syntax_bg,     s:hue_5,          '')
  ...
  call <sid>X('String',         s:hue_6,         '',          '')
  call <sid>X('Character',      s:hue_6,         '',          '')
  ...
  call <sid>X('Include',        s:hue_5,         '',          '')
  call <sid>X('Define',         s:hue_5,         '',          'none')
  call <sid>X('Macro',          s:hue_5,         '',          '')
  call <sid>X('PreCondit',      s:hue_5,         '',          '')
  call <sid>X('Type',           s:mono_2,         '',          'none') " hue_5
  call <sid>X('StorageClass',   s:hue_4,         '',          '')
  call <sid>X('Structure',      s:hue_4,         '',          '')
  call <sid>X('Typedef',        s:mono_2,         '',          '') " hue_5
  call <sid>X('Special',        s:hue_2,         '',          '')
  ...
  " call <sid>X('cPreCondit',         s:hue_5,  '', '')
  " call <sid>X('cPreConditMatch',    s:hue_5,  '', '')

  " call <sid>X('cType',              s:hue_4,  '', '')
  " call <sid>X('cStorageClass',      s:hue_5,  '', '')
  " call <sid>X('cStructure',         s:hue_5,  '', '')
  call <sid>X('cOperator',          s:hue_2,  '', '')
  ...
  call <sid>X('cString',            s:hue_6,  '', '')

  " call <sid>X('cppType',            s:hue_4,  '', '')
  " call <sid>X('cppStorageClass',    s:hue_5,  '', '')
  " call <sid>X('cppStructure',       s:hue_5,  '', '')
  call <sid>X('cppModifier',        s:hue_4,  '', '')
  call <sid>X('cppOperator',        s:hue_2,  '', '')
  call <sid>X('cppAccess',          s:hue_3,  '', '')
  call <sid>X('cppStatement',       s:hue_3,  '', '')
  call <sid>X('cppConstant',        s:hue_6,  '', '')
  call <sid>X('cCppString',         s:hue_6,  '', '')
  " }}}
  ...
  call <sid>X('zshVariableDef',  s:hue_2,     '', '')
  " }}}
...
syntax keyword cppNaglowkiFor FOR REP FORD REPD
syntax keyword cppNaglowkiType L VL VVL VI VVI II VII VVII VB VVB LD
syntax keyword cppNaglowkiConst D I nl inf inf_l
highlight link cppNaglowkiFor Repeat
highlight link cppNaglowkiType Type
highlight link cppNaglowkiConst Constant
